...
```
  [1] = {
    title = "INSTANCE 1",
    buttons = {
      { label="Position",  type="momentary",    logo="mat.png" },
      { label="Intér&Extér",  type="momentary",    logo="lum1.png" },
      { label="Plongeur",  type="momentary",    logo="lum2.png" },
      { label="Restreint",  type="momentary",    logo="lum3.png" },
      { label="Pas Manoeuv",  type="momentary",    logo="" },
      { label="Echoué",  type="momentary",    logo="" },
      { label="Mouillage",  type="momentary",    logo="" },
      { label="Remorquage",  type="momentary",    logo="remorquage.png" },
      { label="Matièr Danger",  type="momentary",    logo="danger.png" },
      { label="Noël",  type="momentary",    logo="noel.png" },
      { label="Chenillard",  type="momentary",    logo="chenillard.png" },
      { label="12",  type="momentary",    logo="" },
      { label="13",  type="momentary",    logo="" },
      { label="14",  type="momentary",    logo="" },
      { label="Radar",  type="momentary",    logo="radar.png" },
      { label="Tout Off",  type="momentary",    logo="off.png" },
    },
    prop = { label = "Luminosite", logo="sound.png" },
  },
```
